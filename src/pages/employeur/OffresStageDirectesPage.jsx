...
{/*
    Remplacez cet espace réservé par une véritable page employeur capable de:

    -Charger les offres directes de l’employeur: GET /api/offres-stage-directes/mes.
    -Créer une nouvelle offre directe: POST /api/offres-stage-directes.
    -Afficher les offres directes envoyées dans un tableau.
